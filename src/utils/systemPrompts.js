...
const CHILD_PROMPT = `You are 'Aloha', a warm and friendly AI assistant specializing in child care facilities.
...
const ELDERLY_PROMPT = `You are 'Aloha', a polite and clear AI assistant specializing in elderly care facilities.
...
export function getSystemPrompt(facilityType) {
  if (facilityType === "child") return CHILD_PROMPT;
  if (facilityType === "elderly") return ELDERLY_PROMPT;
  return CHILD_PROMPT;
}
